...
// visualize.
//
// See the contrib package ( https://pkg.go.dev/github.com/lsgndln/dd-trace-go/contrib )
...
// (See the net/http contrib package for more examples https://pkg.go.dev/github.com/lsgndln/dd-trace-go/contrib/net/http):
//
...
// https://godoc.org/github.com/lsgndln/dd-trace-go/contrib
package tracer // import "github.com/lsgndln/dd-trace-go/ddtrace/tracer"
