...
[![Godoc](http://img.shields.io/badge/godoc-reference-blue.svg?style=flat)](https://pkg.go.dev/github.com/lsgndln/dd-trace-go)
...
The package [`github.com/lsgndln/dd-trace-go/ddtrace/tracer`](https://pkg.go.dev/github.com/lsgndln/dd-trace-go/ddtrace/tracer) allows you to trace any piece of your Go code, and commonly used Go libraries can be automatically traced thanks to our out-of-the-box integrations which can be found in the package [`github.com/lsgndln/dd-trace-go/ddtrace/contrib`](https://pkg.go.dev/github.com/lsgndln/dd-trace-go/contrib).
...
The package [`github.com/lsgndln/dd-trace-go/profiler`](https://pkg.go.dev/github.com/lsgndln/dd-trace-go/profiler) allows you to periodically collect and send Go profiles to the Datadog API.
...
Additionally there are many [contrib](./contrib) packages that can be installed to automatically instrument and trace commonly used Go libraries such as [net/http](https://pkg.go.dev/github.com/lsgndln/dd-trace-go/contrib/net/http), [gorilla/mux](https://pkg.go.dev/github.com/lsgndln/dd-trace-go/contrib/gorilla/mux) or [database/sql](https://pkg.go.dev/github.com/lsgndln/dd-trace-go/contrib/database/sql):
...
### Documentation
 ...
 - [APM Tracing API](https://pkg.go.dev/github.com/lsgndln/dd-trace-go/ddtrace)
